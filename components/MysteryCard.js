const MysteryCard = props => (
  <div className="card">
    <div className="card-info">
      <p>The case of the prime number spiral</p>
    </div>
    <div className="card-content">
      <div>
        <video>
          <source src="https://d3el26csp1xekx.cloudfront.net/v/no-wm-y9RSZSnG9J.mp4" type="video/mp4" />
        </video>
